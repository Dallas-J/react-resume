...
const Footer: FC = memo(() => (
  <div className="relative bg-neutral-500 dark:bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pt-14 sm:pb-8">
    <div className="absolute inset-x-0 -top-4 flex justify-center sm:-top-6">
      <Link
        className="rounded-full bg-neutral-400 dark:bg-neutral-100 p-1 ring-orange-600 ring-offset-2 ring-offset-gray-700/80 focus:outline-none focus:ring-2 sm:p-2"
        to={`#${SectionId.Hero}`}
      >
