    ...
    <div className="flex flex-col pb-8 text-left last:pb-0 text-gray-800 dark:text-gray-300">
      <div className="flex flex-col pb-4">
        ...
        <div className="flex items-center justify-center gap-x-2 md:justify-start">
          <span className="flex-none text-sm font-medium italic text-black dark:text-white">{location}</span>
          <span>•</span>
          <span className="flex-none text-sm text-gray-800 dark:text-gray-300">{date}</span>
        </div>
      </div>
      {content}
    </div>
